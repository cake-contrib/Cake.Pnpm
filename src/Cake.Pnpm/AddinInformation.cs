...
{
    private static readonly string InformationalVersion = typeof(AddinInformation).GetTypeInfo().Assembly
        .GetCustomAttribute<AssemblyInformationalVersionAttribute>()?.InformationalVersion;

    private static readonly string AssemblyVersion =
        typeof(AddinInformation).GetTypeInfo().Assembly.GetName().Version?.ToString();
